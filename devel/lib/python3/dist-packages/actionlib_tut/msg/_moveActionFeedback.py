...
"""autogenerated by genpy from actionlib_tut/moveActionFeedback.msg. Do not edit."""
import sys
...
class moveActionFeedback(genpy.Message):
  _md5sum = "d1c591949bf3b324304d07927b4fc7fa"
  _type = "actionlib_tut/moveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','actionlib_tut/moveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = actionlib_tut.msg.moveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = actionlib_tut.msg.moveFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.feedback.feedback_num))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.feedback_num,) = _get_struct_i().unpack(str[start:end])
      return self
