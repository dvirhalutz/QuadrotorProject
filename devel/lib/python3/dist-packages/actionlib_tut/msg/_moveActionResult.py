...
"""autogenerated by genpy from actionlib_tut/moveActionResult.msg. Do not edit."""
import sys
...
class moveActionResult(genpy.Message):
  _md5sum = "193367f95d4f2fde3d1d5d413d491c25"
  _type = "actionlib_tut/moveActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','actionlib_tut/moveResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = actionlib_tut.msg.moveResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = actionlib_tut.msg.moveResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.result.res_num))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.res_num,) = _get_struct_i().unpack(str[start:end])
      return self
