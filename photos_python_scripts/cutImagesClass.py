...
class cutImages():
    ...
    def __init__(self, path_folder_images_to_upload, path_folder_images_to_save, image_starting_with, final_image_size=252, image_format='PNG', verbos=0, isWithoutMan=False):
        ...
        self.isWithoutMan = isWithoutMan
    ...
    def cut_images_and_save_them(self):
        ...
        for img_path in self.all_photos_list:
            ...
            # x_0 = 514
            # x_f = 766
            if self.isWithoutMan:
                y_0 = 0
                y_f = self.final_image_size
                x_0 = 0
                x_f = self.final_image_size
            else:
